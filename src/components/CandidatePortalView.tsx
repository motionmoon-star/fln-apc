...
export const CandidatePortalView: React.FC<CandidatePortalViewProps> = ({
  ...
  return (
    <div className={`min-h-screen bg-slate-100/80 text-slate-900 flex flex-col font-sans ${isAr ? 'font-arabic' : ''}`}>
      
      {/* Algerian National Ribbon */}
      <div className="h-1.5 w-full bg-gradient-to-r from-emerald-600 via-white to-red-600 shadow-xs relative z-30" />
            ...
            <div className="flex items-center justify-between min-w-0">
              <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <h1 className="text-xs sm:text-sm md:text-base font-black text-slate-900 leading-tight truncate mt-0.5">
      ...
      <div className="bg-gradient-to-r from-emerald-950 via-emerald-900 to-slate-900 text-emerald-50 px-3 sm:px-6 py-2 shadow-inner border-b border-emerald-800/80">
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 sm:px-6 py-5 space-y-5">
        ...
        {isEditing ? (
          /* ================= CORRECTION FORM ================= */
          <form onSubmit={handleSaveCorrections} className="bg-white rounded-2xl border-2 border-emerald-500/80 shadow-md p-4 sm:p-6 space-y-6">
            ...
            {activeTab === 'info' && (
              <div className="space-y-4">
                ...
                <div className="bg-white rounded-2xl border-2 border-emerald-600/30 shadow-sm overflow-hidden">
                  <div className="p-3 bg-gradient-to-r from-emerald-800 to-emerald-900 text-white flex items-center justify-between gap-2">
                    <div className="flex items-center gap-2">
      ...
      {isPasswordModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs">
          <div className="bg-white rounded-2xl max-w-sm w-full p-5 sm:p-6 shadow-2xl border border-slate-200 space-y-4 animate-in fade-in zoom-in-95 duration-150">
